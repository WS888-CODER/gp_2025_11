...
abstract class AppLocalizations {
  ...
  /// No description provided for @generalSettingsSection.
  ///
  /// In en, this message translates to:
  /// **'General Settings'**
  String get generalSettingsSection;
  ...
  /// No description provided for @manageAlertsSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Manage your alerts and pushes'**
  ...
  /// No description provided for @viewOnlyText.
  ///
  /// In en, this message translates to:
  /// **'View Only'**
  String get viewOnlyText;

  /// No description provided for @myAccountDetailsSection.
  ///
  /// In en, this message translates to:
  /// **'My Account Details'**
  String get myAccountDetailsSection;
  ...
  /// No description provided for @registeredEmailLabel.
  ///
  /// In en, this message translates to:
  /// **'Registered Email'**
  ...
  /// No description provided for @logoutOption.
  ///
  /// In en, this message translates to:
  /// **'Logout'**
